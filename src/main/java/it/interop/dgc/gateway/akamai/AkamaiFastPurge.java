...
public class AkamaiFastPurge {
    ...
    @PostConstruct
    private void initRestTactory()
        throws RestApiException, GeneralSecurityException, IOException {
        if (url != null && !"".equals(url)) {
            ...
            HttpClientBuilder clientBuilder = HttpClientBuilder
                ...
                .addInterceptorFirst(
                    new ApacheHttpClientEdgeGridInterceptor(credential)
                );
    ...
    public String invalidateUrls() {
        ...
        URI uri = UriComponentsBuilder.fromUriString(getUrl()).build().toUri();
        ...
        HttpEntity<String> entity = new HttpEntity<String>(
            getUrlsStringRequestBody(urls),
            headers
        );

        ResponseEntity<String> respEntity = getRestTemplate()
    ...
    public String invalidateRulesUrls() {
        ...
        HttpEntity<String> entity = new HttpEntity<String>(
            getCpcodesStringRequestBody(cpcodes),
            headers
        );
    ...
    public static String getCpcodesStringRequestBody(String urls) {
        ...
        akamaiRequestMap.put(
            "objects",
            Stream.of(urls.split(",")).mapToInt(Integer::parseInt).toArray()
        );
        return new Gson().toJson(akamaiRequestMap);
    }
}
