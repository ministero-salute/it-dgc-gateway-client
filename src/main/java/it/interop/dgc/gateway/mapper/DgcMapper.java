...
public class DgcMapper {
    ...
    public static SignerInformationEntity trustListDtoToEntity(
        TrustListItemDto trustList
    ) {
    ...
    public static SignerInvalidInformationEntity invalidTrustListDtoToEntity(
        TrustListItemDto trustList
    ) {
        SignerInvalidInformationEntity signerInvalidInformationEntity = null;
        if (trustList != null) {
            signerInvalidInformationEntity =
                new SignerInvalidInformationEntity();
            signerInvalidInformationEntity.setKid(trustList.getKid());
            signerInvalidInformationEntity.setCountry(trustList.getCountry());
            signerInvalidInformationEntity.setCertificateType(
                trustList.getCertificateType()
            );
            signerInvalidInformationEntity.setThumbprint(
                trustList.getThumbprint()
            );
            signerInvalidInformationEntity.setSignature(
                trustList.getSignature()
            );
