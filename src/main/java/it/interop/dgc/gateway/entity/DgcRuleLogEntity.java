...
public class DgcRuleLogEntity implements Serializable {
    ...
    public static DgcRuleLogEntity buildUploadRuleLog(
        String batchTag,
        String executionReport
    ) {
        DgcRuleLogEntity dgcLogEntity = new DgcRuleLogEntity(
    ...
    public static DgcRuleLogEntity buildRevokeRuleLog(
        String batchTag,
        String executionReport
    ...
    public static DgcRuleLogEntity buildDownloadCountyLog(
        String batchTag,
        String executionReport
    ) {
        DgcRuleLogEntity dgcLogEntity = new DgcRuleLogEntity(
    ...
    public static DgcRuleLogEntity buildDownloadValueLog(
        String batchTag,
        String executionReport
    ) {
        DgcRuleLogEntity dgcLogEntity = new DgcRuleLogEntity(
    ...
    public static DgcRuleLogEntity buildDownloadRuleLog(
        String batchTag,
        String executionReport,
        String executionAkamaiReport,
        Map<String, List<DgcRuleLogInfo>> logInfoList,
        DgcRuleLogAmount logAmount
    ) {
        DgcRuleLogEntity dgcLogEntity = new DgcRuleLogEntity(
            DgcRuleLogEntity.OperationType.DOWNLOAD,
            ItemType.RULES,
